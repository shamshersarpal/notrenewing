            ...
            <div className="p-8">
              <div className="prose prose-blue max-w-none">
                ...
                <section className="mb-8">
                  ...
                  <p>
                    At NotRenewing.com, we respect your privacy and are
                    committed to protecting it through our compliance with this
                    policy. This Privacy Policy describes the types of
                    information we may collect from you or that you may provide
                    when you visit NotRenewing.com and our practices for
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc pl-6 space-y-2 my-4">
                    <li>
                      ...
                      such as name, postal address, email address, telephone
                      number, or any other identifier by which you may be
                      contacted online or offline.
                    </li>
                    <li>
                      <strong>Payment Information:</strong> When you make a
                      purchase, we collect payment information necessary to
                      process the transaction.
                    </li>
                    <li>
                      <strong>Domain Information:</strong> If you list a domain
                      for sale, we collect information about that domain.
                    </li>
                    <li>
                      <strong>Usage Information:</strong> We collect information
                      about your use of our website, including the pages you
                      visit, the time and date of your visit, and the time spent
                      on each page.
                    </li>
                  </ul>
                </section>
                <section className="mb-8">
                  ...
                  <ul className="list-disc pl-6 space-y-2 my-4">
                    ...
                    <li>
                      To process payments and facilitate domain transfers.
                    </li>
                    <li>
                ...
                <section className="mb-8">
                  ...
                  <ul className="list-disc pl-6 space-y-2 my-4">
                    ...
                    <li>
                      ...
                      or other sale or transfer of some or all of NotRenewing
                      Inc.'s assets.
                    </li>
                ...
                <section className="mb-8">
                  ...
                  <p>
                    ...
                    behind firewalls. Any payment transactions will be encrypted
                ...
                <section className="mb-8">
                  ...
                  <p>
                    ...
                    personal information. You may also have the right to object
                    to processing and the right to data portability.
                  </p>
                  <p>
                    To exercise any of these rights, please contact us at
                    privacy@notrenewing.com. We will respond to your request
                ...
                <section className="mb-8">
                  ...
                  <p>
                    ...
                    website home page or by email to the email address specified
                    in your account.
                  </p>
                  <p>
                    The date the Privacy Policy was last revised is identified
                    at the top of the page. You are responsible for ensuring we
                    have an up-to-date active and deliverable email address for
                    you, and for periodically visiting our website and this
